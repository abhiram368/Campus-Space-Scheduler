...
public class BookingDetailsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvSpaceName = findViewById(R.id.detailsSpaceName);
        tvUserName = findViewById(R.id.detailsUserName);
        tvDate = findViewById(R.id.detailsDate);
        tvTime = findViewById(R.id.detailsTime);
        tvPurpose = findViewById(R.id.detailsPurpose);
        tvDescription = findViewById(R.id.detailsDescription);
        tvStatus = findViewById(R.id.detailsStatus);
        tvRemarks = findViewById(R.id.detailsRemarks);
        tvLabelStatus = findViewById(R.id.labelStatus);
        tvLabelRemarks = findViewById(R.id.labelRemarks);
        
        btnApprove = findViewById(R.id.btnApproveDetail);
        btnForward = findViewById(R.id.btnForwardDetail);
        btnReject = findViewById(R.id.btnRejectDetail);
        btnViewLor = findViewById(R.id.btnViewLor);
        btnCancelApprovedBooking = findViewById(R.id.btnCancelApprovedBooking);
    ...
    private void loadBookingDetails() {
        bookingsRef.child(bookingId).addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(BookingDetailsActivity.this, "Booking Read Failed: " + error.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    private void handleCancellation() {
        new AlertDialog.Builder(this)
            ...
            .setPositiveButton("Yes, Cancel", (dialog, which) -> {
                updateBooking("cancelled", "cancelled", "Cancelled by Hall Incharge");
            })
    ...
    private void updateBooking(String status, String hallInchargeApproval, String remarks) {
        String approverUid = FirebaseAuth.getInstance().getUid();
        
        Map<String, Object> updates = new HashMap<>();
        updates.put("status", status);
        updates.put("hallInchargeApproval", hallInchargeApproval);
