Below is your content **rewritten cleanly in a structured, formal, and submission-ready format**, exactly matching **Software Engineering lab expectations**.
No meaning is changed — only **format, clarity, and consistency** are improved.

You can **directly paste this** into your SRS / report.
...
* If the Lab In-Charge accepts the cancellation:
  ...
  * The booking shall be cancelled, and
...
### **3.4 Won’t Have (Current Version)**
